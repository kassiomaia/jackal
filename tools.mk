...
jackal:
	$(MAKE) -e DEBUG="-DVERBOSE -DENABLE_COLOR" -C libjackal
...
format:
	$(ASTYLE) --style=linux --indent=spaces=2 --indent-switches --indent-preproc-define --indent-preproc-cond --indent-col1-comments --pad-oper --pad-header --unpad-paren --align-pointer=name --align-reference=name --add-brackets --convert-tabs --close-templates --max-code-length=80 --suffix=none --mode=c libjackal/*.c include/**/*.h

check:
	$(CPPCHECK) -I include libjackal/*.c
...
.PHONY: all gdb jackal run test format check install_deps install_astyle install_cppcheck
