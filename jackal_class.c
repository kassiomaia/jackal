...
jkl_method_t* jkl_method_new(jkl_string_t name, jkl_word_t arity, jkl_word_t flags, jkl_word_t (*fn)()) {
...
void jkl_class_include(jkl_class_t *klass, jkl_class_t *include)
{
  ...
  if (klass->includes == NULL) {
    ...
    klass->includes = realloc(klass->includes, sizeof(jkl_class_t*) * (klass->n_includes + 1));
    if (klass->includes == NULL)
      jkl_error("jkl_class", "failed to allocate memory for included classes");
...
jkl_word_t jkl_class_add_method(jkl_class_t *klass, jkl_method_t *method)
{
  ...
  if (klass->methods == NULL) {
    ...
    klass->methods = realloc(klass->methods, sizeof(jkl_method_t*) * (klass->n_methods + 1));
    if (klass->methods == NULL)
      jkl_error("jkl_class", "failed to allocate memory for methods");
...
void jkl_class_init()
{
  ...
  jkl_class_add_method(Base, jkl_method_new("new", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Base, jkl_method_new("to_hash", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Base, jkl_method_new("attributes", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Base, jkl_method_new("methods", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Base, jkl_method_new("base", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Base, jkl_method_new("includes", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  ...
  jkl_class_add_method(String, jkl_method_new("new", 1, JKL_METHOD_STATIC_OVERRIDE, jkl_not_implemented));
  jkl_class_add_method(String, jkl_method_new("length", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(String, jkl_method_new("concat", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(String, jkl_method_new("split", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(String, jkl_method_new("replace", 2, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(String, jkl_method_new("reverse", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(String, jkl_method_new("at", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  ...
  jkl_class_add_method(Integer, jkl_method_new("new", 1, JKL_METHOD_STATIC_OVERRIDE, jkl_not_implemented));
  ...
  jkl_class_add_method(Float, jkl_method_new("new", 1, JKL_METHOD_STATIC_OVERRIDE, jkl_not_implemented));
  ...
  jkl_class_add_method(Boolean, jkl_method_new("new", 1, JKL_METHOD_STATIC_OVERRIDE, jkl_not_implemented));
  ...
  jkl_class_add_method(Array, jkl_method_new("new", 1, JKL_METHOD_STATIC_OVERRIDE, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("length", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("at", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("push", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("pop", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("shift", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("unshift", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("insert", 2, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("remove", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("clear", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("each", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("map", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("filter", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("reduce", 2, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("reverse", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("sort", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(Array, jkl_method_new("join", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  ...
  jkl_class_add_method(IO, jkl_method_new("new", 0, JKL_METHOD_STATIC_OVERRIDE, jkl_not_implemented));
  jkl_class_add_method(IO, jkl_method_new("print", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(IO, jkl_method_new("println", 1, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(IO, jkl_method_new("read", 0, JKL_METHOD_STATIC, jkl_not_implemented));
  jkl_class_add_method(IO, jkl_method_new("readln", 0, JKL_METHOD_STATIC, jkl_not_implemented));
